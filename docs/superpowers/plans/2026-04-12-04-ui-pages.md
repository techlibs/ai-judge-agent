...
**Architecture:** Next.js App Router with Server Components for data fetching, Client Components for interactivity. The evaluation theater polls for judge completion status and renders results as each Mastra agent finishes its evaluation.

**Tech Stack:** Next.js 15, React 19, shadcn/ui, Tailwind CSS 4.
